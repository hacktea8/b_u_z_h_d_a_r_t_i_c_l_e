      ...
      method="post">
        ...
        <div class="ui_text_block">
          ...
          <div id="Post_content" class="edui-default">
            <div id="edui1" class="edui-editor  edui-default" style="width: 100%; z-index: 0;">
              ...
              style="width: 100%; height: 600px; z-index: 999; overflow: hidden;">
                ...
                body{margin:8px;font-family:sans-serif;font-size:16px;}p{margin:5px 0;}</style><link rel='stylesheet' type='text/css' href='/assets/3ec043fb/themes/iframe.css'/></head><body class='view' ></body><script type='text/javascript'  id='_initialScript'>setTimeout(function(){editor = window.parent.UE.instants['ueditorInstant0'];editor._setup(document);},0);var _tmpScript = document.getElementById('_initialScript');_tmpScript.parentNode.removeChild(_tmpScript);</script></html>&quot;);document.close();}())">
                </iframe>
              </div>
