...
<?php require_once 'my_rightbar.php';?>
    	...
    	<div class="mt20 ui_blockbg member_block">
    		...
    		<div class="p20">
	    		    		    <form enctype="multipart/form-data" id="Channel-form" action="/channel.html" method="post">    			<div class="ui_text_block">
    				<label class="fcEm3 title" for="pubTitle">*頻道名稱：</label>
    				<input class="ui_text_input" name="Channel[name]" id="Channel_name" type="text" maxlength="100" value="<?php echo $channel['title'];?>" />    				    			</div>
    			...
    			<div class="ui_text_block">
    				...
    				<div class="ib tc">
    					...
    					<a class="ui_btn ui_btn_white" href="#" id="yt0">清除圖示</a>    				</div>
    			</div>
    			<div class="ui_text_block">
