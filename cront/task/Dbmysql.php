...
class Dbmysql{
  ...
  function update($table = null,$fields = null,$where = null){
    $sql = $this->update_string($table, $fields, $where);
    if( !$sql){
       return $sql;
    }
  ...
  function select_string($table = null, $fieldsStr = null, $limit = array(), $where = array(), $order = array()){
    if( !$table || !$fieldsStr){
       return false;
    }
  ...
  function insert($table = null,$fields = null){
     ...
     $sql = $this->insert_string($table , $fields);
     if( !$sql){
        return false;
     }
     $query = $this->query($sql);
